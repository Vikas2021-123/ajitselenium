...
public static void main(String[] args) {
	...
	Actions acts = new Actions(driver);
	  ...
	  s.keyDown(firstname, Keys.CONTROL).sendKeys("a").keyUp(Keys.CONTROL).build().perform();
	  
	  s.keyDown(Keys.CONTROL).sendKeys("c").keyUp(Keys.CONTROL).build().perform();
	  
	WebElement lastname = driver.findElement(By.xpath("//*[@name='lastname']"));
	
	s.click(lastname).perform();
	  s.keyDown( Keys.CONTROL).sendKeys("v").keyUp(Keys.CONTROL).build().perform();
